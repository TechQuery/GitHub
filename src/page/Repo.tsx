                ...
                <div className="panel-body">
                  <div className="row">
                    <div className="col-xs-3 text-center">
                      <strong>{repository.stargazers_count}</strong><br/>
                      <small>Stars</small>
                    </div>
                    <div className="col-xs-3 text-center">
                      <strong>{repository.forks_count}</strong><br/>
                      <small>Forks</small>
                    </div>
                    <div className="col-xs-3 text-center">
                      <strong>{repository.language || 'N/A'}</strong><br/>
                      <small>语言</small>
                    </div>
                    <div className="col-xs-3 text-center">
            ...
            <div className="col-md-4">
              <div className="panel panel-default">
                ...
                <div className="panel-body text-center">
                  <img src={repository.owner.avatar_url} className="img-circle" width={64} height={64} alt={repository.owner.login} />
                  <h4><a href={`#/users/${repository.owner.login}`}>{repository.owner.login}</a></h4>
                </div>
              </div>
            </div>
          </div>
