            ...
            <div className="panel-body">
                ...
                <div className="progress">
                    <div
                        ...
                        style={{
                            width: `${(closed_issues / (open_issues + closed_issues)) * 100}%`
                        }}
                    >
                ...
                return (
                    <div>
                        ...
                        {repoContents.length === 0 ? (
                            ...
                            <ul className="list-group">{repoContents.map(this.renderFileItem)}</ul>
                        )}
                    </div>
                );
                ...
                return (
                    <div>
                        ...
                        {repoCommits.length === 0 ? (
                            ...
                            <div>{repoCommits.map(this.renderCommitItem)}</div>
                        )}
                    </div>
                );
                ...
                return (
                    <div>
                        ...
                        {repoMilestones.length === 0 ? (
                            ...
                            <div>{repoMilestones.map(this.renderMilestoneItem)}</div>
                        )}
                    </div>
                );
