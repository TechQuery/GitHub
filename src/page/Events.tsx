...
import { GitHubEvent, githubStore } from '../model/github';
        ...
        >
            ...
            <div className="media-body">
                <h5 className="media-heading">
                    <Link to={`/users/${actor.login}`}>{actor.login}</Link>
                    {' ' + type}
            ...
            <div className="row">
                <div className="col-md-12">
                    ...
                    <div className="panel panel-default">
                        <div className="panel-body">{events.map(this.renderEventItem)}</div>
                    </div>
                </div>
            </div>
        );
